...
def main():
    ...
    forcing_file = base_dir / 'forcing1D.Css_Lab.2023-10-01-2024-10-01.temp_adjusted.txt'
    ...
    configs = {
        ...
        'Combined': SnowConfig(
            ...
            rain_snow_params={'t_all_snow': 273.15 + 1.0, 't_all_rain': 273.15 + 3.0},
            albedo_method='vic',
            albedo_params={'thaw_a': 0.80, 'thaw_b': 0.50},  # Faster thaw decay
            phase_change_method='hierarchy',
            cold_content_tax=True,
            ground_flux_const=1.0,  # Reduced ground heat
            t_soil=273.15 + 3.0,    # Cooler soil
        ),
        ...
        'SNICAR-lite': SnowConfig(
            ...
            albedo_params={'dr_wet': 80.0},  # Faster wet grain growth
            phase_change_method='hierarchy',
            ground_flux_const=2.0,
            t_soil=273.15 + 5.0,
        ),
        ...
        'Reduced-G': SnowConfig(
            ...
            albedo_method='vic',
            phase_change_method='hierarchy',
            ground_flux_const=0.5,  # Much reduced
            t_soil=273.15 + 2.0,    # Cooler soil
        ),
    }
